...
import by.kirill.text.service.TextEditService;
...
public class TextEditServiceTest {
    ...
    @Test
    public void deleteSentences() throws TextHandlerException {
        TextEditService changeService = new TextEditService();
        changeService.deleteSentencesWhereWordCountLessThenCurrent((TextComposite)rootComponent, 5);
